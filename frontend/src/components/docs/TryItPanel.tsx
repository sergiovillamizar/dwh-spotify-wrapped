              ...
              {[...pathParams, ...queryParams].map((param) => (
                <div key={param.name} className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full bg-spotify-dark-800 border border-glass-border rounded-lg px-3 py-2 text-sm font-mono text-white placeholder-spotify-dark-500 focus:outline-none focus:border-spotify-green/50 focus:ring-1 focus:ring-spotify-green/30"
                  />
                </div>
              ))}
            </div>
